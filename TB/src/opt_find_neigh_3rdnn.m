    ...
    for layer = 1 : nlayer
        ...
        for isym = [-1,1]
            ...
            for ii = 1:norbs
                ...
                orbitals(iorb).Intra_nn1_hoppings = assign_hoppings(a1,a2,delta,...
		    1,layer,M2sym,ir,jr,type1,type2,type3,type4,type5,type6);
                ...
                orbitals(iorb).Intra_nn2_hoppings = assign_hoppings(a1,a2,delta,...
		    2,layer,M2sym,ir,jr,type1,type2,type3,type4,type5,type6);
                ...
                if(isym > 0)
                    ...
                    orbitals(iorb).Intra_nn3_hoppings = assign_hoppings(a1,a2,delta,...
	                3,layer,M2sym,ir,jr,type1,type2,type3,type4,type5,type6);
